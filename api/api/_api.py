...
def get_list_intersection_counts() -> Dict[str, int]:
    ...
    # The variables below are created to store number of common errors.
    resolved_unresolved: int = 0
    resolved_backlog: int = 0
    unresolved_backlog: int = 0

    # As I am not a python hero, I just employed nested for loops. Can be optimzed with list comprehensions maybe

    for res in resolved:
        for unres in unresolved:
            if res['code'] == unres['code']:
